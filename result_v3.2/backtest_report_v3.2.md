...
| 参数 | 值 | 说明 |
|------|-----|------|
| theta_buy | -3.05 | 买入BIAS评分参考值（%，负值） |
| theta_sell | 13.52 | 卖出乖离率阈值（%） |
| alpha_vol | 0.5 | 缩量系数（0.5-0.8） |
| rsi_thresh | 32 | RSI评分参考值 |
| score_threshold | 0.6 | 信号评分阈值（0-1） |
